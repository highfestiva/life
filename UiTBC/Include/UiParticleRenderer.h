...
public:
	...
	void CreateExplosion(const Vector3DF& pPosition, float pStrength, const Vector3DF& pDirection, float pFalloff, float pTime, const Vector3DF& pStartFireColor, const Vector3DF& pFireColor,
