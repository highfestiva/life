...
const char* OpenGLMatTextureAndLightmapPXS::smVP =
{
	"!!ARBvp1.0\n\
	 ...
	 ATTRIB iTCoord1 = vertex.texcoord[1];       # input texture coordinates\n\
	 \n\
	 ...
	 OUTPUT oTCoord0   = result.texcoord[2];\n\
	 OUTPUT oTCoord1   = result.texcoord[3];\n\
	 \n\
...
const char* OpenGLMatTextureAndLightmapPXS::smFP[NUM_FP] =
{
