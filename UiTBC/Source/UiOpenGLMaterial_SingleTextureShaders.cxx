...
const astr OpenGLMatSingleTextureSolidPXS::smVP =
	"!!ARBvp1.0\n\
	 ...
	 ATTRIB iTCoord = vertex.texcoord;          # input texture coordinates\n\
	 \n\
	 ...
	 OUTPUT oTCoord    = result.texcoord[2];\n\
	 \n\
	 ...
	 \n\
	 DP4 oTCoord.x, iTCoord, mtx[0];\n\
	 DP4 oTCoord.y, iTCoord, mtx[1];\n\
	 DP4 oTCoord.z, iTCoord, mtx[2];\n\
	 DP4 oTCoord.w, iTCoord, mtx[3];\n\
...
ATTRIB iTCoord    = fragment.texcoord[2];\n\
\n\
...
DP3 Temp.x, "#ldir", "#ldir";\n\
RSQ Temp.x, Temp.x;\n\
MUL Temp, "#ldir", Temp.x;\n\
DP3 fSpotNorm, Temp, -L;\n\
...
RSQ Temp.x, Temp.x;\n\
MUL Temp, "#ldir", Temp.x;\n\
SUB H, Temp, V;                     # half-angle vector\n\
DP3 H.w, H, H;                      # normalize it\n\
RSQ H.w, H.w;\n\
MUL H, H, H.w;\n\
\n\
DP3 toLIT.x, N, Temp;               # diffuse dot product\n\
DP3 toLIT.y, N, H;                  # specular dot product\n\
LIT fromLIT, toLIT;\n\
MAD DiffuseCol, "#lcol", fromLIT.y, DiffuseCol;\n\
MAD SpecularCol, "#lcol", fromLIT.z, SpecularCol;\n\
...
const astr OpenGLMatSingleTextureSolidPXS::smFP[NUM_FP] =
{
	// Ambient light only.
	"!!ARBfp1.0\n\
	 ATTRIB iPrimCol   = fragment.color.primary;\n\
