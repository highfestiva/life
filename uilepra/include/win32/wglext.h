...
typedef BOOL (WINAPI * PFNWGLDESTROYIMAGEBUFFERI3DPROC) (HDC hDC, LPVOID address);
typedef BOOL (WINAPI * PFNWGLASSOCIATEIMAGEBUFFEREVENTSI3DPROC) (HDC hDC, const HANDLE *event, const LPVOID *address, const DWORD *_size, UINT count);
typedef BOOL (WINAPI * PFNWGLRELEASEIMAGEBUFFEREVENTSI3DPROC) (HDC hDC, const LPVOID *address, UINT count);
#endif

#ifndef WGL_I3D_swap
#define WGL_I3D_swap 1
#ifdef WGL_WGLEXT_PROTOTYPES
