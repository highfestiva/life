...
//Name: lvl14.ma
//Last modified: Fri, Mar 14, 2014 03:47:39 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 32.013149524235871 17.103028499573362 -188.89964364122625 ;
	setAttr ".r" -type "double3" -7.5383527298720416 341.39999999974765 -6.2921911774761709e-016 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 3000;
	setAttr ".coi" 187.99919511236129;
...
createNode transform -n "phys_trig_car_eater" -p "m_ground";
	setAttr ".t" -type "double3" -43.889875403891651 -62.048792889939648 -22.340118219409572 ;
	setAttr ".r" -type "double3" 0 -3.1805546814635168e-015 0 ;
	setAttr ".s" -type "double3" 1 0.99999999999999978 0.99999999999999978 ;
...
createNode script -n "rg_export";
	...
	setAttr ".time" -type "string" "2014-03-14T15:47:38.997000";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
