...
g = 20 # Gravity constant, m/s^2.
gravity((0,0,-g))

# Setup ground and volleyball net. Ground graphic is rendered 1 meter above physical ground to compensate for half-sphere slimes.
