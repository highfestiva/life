...
void dBodySetMass (dBodyID b, const dMass *mass)
{
  ...
  //high_festiva: dUASSERT( fabs( mass->c[0] ) <= dEpsilon &&
  //high_festiva: 			fabs( mass->c[1] ) <= dEpsilon &&
  //high_festiva: 			fabs( mass->c[2] ) <= dEpsilon, "The centre of mass must be at the origin." )
