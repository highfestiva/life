...
//Last modified: Sun, May 09, 2010 10:57:28 PM
//Codeset: 1252
requires maya "2009";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.20101893983105223 0.58991185896909049 4.3275940913547384 ;
	setAttr ".r" -type "double3" -7.5383527295667276 -356.59999999989913 3.2359466713327878e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 3.9033617606627224;
...
createNode phong -n "green";
	setAttr ".c" -type "float3" 0.048066709 0.72100002 0 ;
...
createNode script -n "rg_export";
	...
	setAttr ".time" -type "string" "2010-05-09T22:57:27.531000";
select -ne :time1;
	setAttr ".o" 1;
...
connectAttr "polyCube1.out" "m_signShape.i";
