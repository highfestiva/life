...
class CrapAI: public SlimeAI
{
	...
	public: void moveSlime()
	{
		...
		if (i < 500)
		{
			if (Math::abs(this->p2X - 800) < 20) { move(3); return; }
			if (this->p2X > 800) { move(0); return; }
		...
		}if (Math::abs(this->p2X - i) < j)
		{
			...
			if (((this->p2X >= 900) && (this->ballX > 830)) || ((this->p2X <= 580) && (this->ballX < 530) && (Math::abs(this->ballX - this->p2X) < 100)))
				...
				jump();
			else if ((Math::abs(this->ballX - this->p2X) < 150) && (this->ballY > 50) && (this->ballY < 400) && (Math::random() < 0.5)) {
				jump();
			}
		}
