...
void SetDefault(Cure::RuntimeVariableScope* pSettings)
{
	...
	v_set(pSettings, RTVAR_UI_DISPLAY_ORIENTATION, _T("AllowUpsideDown"));
	v_set(pSettings, RTVAR_UI_DISPLAY_ENABLEVSYNC, true);
	v_set(pSettings, RTVAR_UI_DISPLAY_RENDERENGINE, _T("OpenGL"));
	...
	v_set(pSettings, RTVAR_UI_3D_SHADOWS, _T("Volumes"));
	v_set(pSettings, RTVAR_UI_3D_SHADOWDEVIATION, 0.0);
	v_set(pSettings, RTVAR_UI_2D_PAINTMODE, _T("Normal"));
	v_set(pSettings, RTVAR_UI_2D_FONT, _T("Times New Roman"));
	v_set(pSettings, RTVAR_UI_2D_FONTHEIGHT, 14.0);
	v_set(pSettings, RTVAR_UI_2D_FONTFLAGS, 0);
	v_set(pSettings, RTVAR_UI_SOUND_ENGINE, _T("OpenAL"));
