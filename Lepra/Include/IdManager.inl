...
{
	IdSegmentList::const_iterator x = mIdSegmentList.begin();
...
{
	IdSegmentList::iterator x = mIdSegmentList.begin();
...
void ID_QUAL::FreeIdOnSegment(_TInt pId, const typename IdSegmentList::iterator& x)
{
	...
	{
		// Create new segment to hold this ID.
		IdSegmentList::iterator z = mIdSegmentList.insert(x, AllocFreeSegment(x->mFirstAllocId, pId, pId));
