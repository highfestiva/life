	...
	def apply_ini_config(self, config, group):
		...
		for section in config.sections():
			if section.startswith("engine:"):
				...
				tagOk = tagtype in ["eye", "brake_light", "reverse_light", "engine_light", "engine_sound", "engine_mesh_offset", "burn", "exhaust", "jet_engine_emitter", "stunt_trigger_data", "race_trigger_data", "upright_stabilizer", "forward_stabilizer", "context_path", "see_through", "ammo", "textures", "anything"]
				allApplied &= tagOk
				if not tagOk:
