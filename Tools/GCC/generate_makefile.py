...
def main():
    basedir = "../../"
    projects = [["lib_nowarn", basedir+"ThirdParty/ThirdPartyLib_800.vcproj"],
                ["lib", basedir+"Lepra/Lepra.vcproj"],
                ["lib", basedir+"TBC/TBC.vcproj"],
                ["lib", basedir+"Cure/Cure.vcproj"],
                ["lib", basedir+"Life/Life.vcproj"],
                ["bin", basedir+"Life/LifeServer/LifeServer.vcproj"]]
