...
bool ClientOptionsManager::SetDefault(int pPriority)
{
	...
	switch (pPriority)
	{
		...
		case 1:
		{
			...
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_UP, _T("Key.NumPad1"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_DOWN, _T("Key.NumPad0"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_HANDBRK, _T("Key.NumPad1"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_BRK, _T("Key.NumPad0"));
			lOk = true;
		}
		break;
		case 2:
		...
		case 3:
		{
			...
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_FWD, _T("Key.NumPad8"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_BACK, _T("Key.NumPad5"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_BRKBACK, _T(""));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_LEFT, _T("Key.NumPad4"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_RIGHT, _T("Key.NumPad6"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_UP, _T("Key.NumPad9"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_DOWN, _T("Key.NumPad7"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_HANDBRK, _T("Key.NumPad9"));
			CURE_RTVAR_OVERRIDE(mVariableScope, RTVAR_CTRL_VEHICLE_BRK, _T("Key.NumPad7"));
			lOk = true;
		}
		break;
	}
