...
public:
	...
	static Vector3DF CalculateInitialProjectileDirection(const Vector3DF& pDistance, float pAcceleration, float pTerminalSpeed, const Vector3DF& pGravity, float pAccelerationGravityRecip);
private:
	LOG_CLASS_DECLARE();
};
